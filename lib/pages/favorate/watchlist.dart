...
''';
  ...
  Widget build(BuildContext context) {
    ...
    var data =
        watch.where((element) => element['user'] == int.parse(x)).toList();
      ...
      body: data.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                List movie = context.watch<ApiCalls>().movieData;
                Map result = movie.firstWhere(
                    (element) => element['id'] == data[index]['movie']);
                return Row(
                  ...
                  children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: result['duration'] == null
                                    ? Text(
                                        formatDate(result['release_year']),
                                        style: const TextStyle(
                              ...
                              Padding(
                                padding: const EdgeInsets.only(
                                    left: 15, top: 5, bottom: 10),
                                child: result['content_type'] == 'movie'
                                    ? const Text(
                                        'Movie',
                                        style: TextStyle(
                                          color: Colors.white,
                    ...
                    GestureDetector(
                      onTap: () {
                        showSeasonPickerBottomSheet(context, result, isOnline);
                      },
                      child: Container(

...
class PaymentBottomSheetEpisode extends StatefulWidget {
  final Map movie;
  final Map episode;
  final Map userdata;
  const PaymentBottomSheetEpisode(
      {Key? key,
      required this.movie,
  ...
  @override
  State<PaymentBottomSheetEpisode> createState() =>
      _PaymentBottomSheetEpisodeState();
}

class _PaymentBottomSheetEpisodeState extends State<PaymentBottomSheetEpisode>
                                ...
                                Center(
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      child: Center(
                                        child: Text(
                                          'Pay TZS  ${double.parse(widget.episode['price']).toStringAsFixed(0)}/=',
                                          style: const TextStyle(
                                              // fontFamily: 'Manane',
                                              color: Colors.white,
                                              fontSize: 16,
